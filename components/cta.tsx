        ...
        <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card/50 backdrop-blur-sm">
          ...
          <div className="relative z-10 px-8 py-16 md:px-16 md:py-24">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="mb-4 text-balance text-4xl font-bold text-foreground md:text-5xl">¿Listo para innovar?</h2>
              <p className="mb-8 text-balance text-lg leading-relaxed text-muted-foreground md:text-xl">
                Transforma tu visión en realidad con nuestro equipo de expertos. Agenda una consulta gratuita y descubre
